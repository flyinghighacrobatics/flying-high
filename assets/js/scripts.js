...
jQuery(document).ready(function() {
	...
	*/
	...
	/*
	    Google maps 57.0336056, 9.8786138
	*/
	var position = new google.maps.LatLng(57.0336056, 9.8786138);
            ...
            success: function(json) {
                ...
                if(json.nameMessage == '' && json.emailMessage == '' && json.messageMessage == '') {
                	form.fadeOut('fast', function() {
                		form.parent('.contact-form').append('<p><span class="violet">Thanks for contacting us!</span> I will get back to you very soon.</p>');
                    });
                }
            }
        });
